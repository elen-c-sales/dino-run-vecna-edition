...
som_ponto = pygame.mixer.Sound(os.path.join("assets", "point.wav"))
...
async def main():
    ...
    while rodando:
        ...
        if not game_over:
            ...
            for obs in obstaculos[:]:
                ...
                if obs.rect.right < 0:
                    ...
                    pontos += 1
                    if pontos > 0 and pontos % 100 == 0: som_ponto.play()
                    vel_jogo += 0.05
        else:
        ...
        # IMPORTANTE: Permite que o navegador processe eventos
